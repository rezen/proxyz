...
function ldap_list($ldap, $base, $filter, $attributes=[], $attributes_only=null, $sizelimit=-1, $timelimit=-1, $deref=null, $controls=null) {
...
function ldap_read($ldap, $base, $filter, $attributes=[], $attributes_only=null, $sizelimit=-1, $timelimit=-1, $deref=null, $controls=null) {
  return \Proxyz\callFunction(__FUNCTION__, [$ldap, $base, $filter, $attributes, $attributes_only, $sizelimit, $timelimit, $deref, $controls]);
}
...
function ldap_search($ldap, $base, $filter, $attributes=[], $attributes_only=null, $sizelimit=-1, $timelimit=-1, $deref=null, $controls=null) {
  return \Proxyz\callFunction(__FUNCTION__, [$ldap, $base, $filter, $attributes, $attributes_only, $sizelimit, $timelimit, $deref, $controls]);
}
